 ...
 * <ul>
 *   <li>Return "FizzBuzz" if i is divisible by both 3 and 5</li>
 *   <li>Return "Fizz" if i is divisible by 3 only</li>
 *   <li>Return "Buzz" if i is divisible by 5 only</li>
 *   <li>Otherwise, return the number itself as a string</li>
 * </ul>
 */
