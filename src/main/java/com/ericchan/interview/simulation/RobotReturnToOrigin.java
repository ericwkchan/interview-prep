...
/**
 * Determines if a robot returns to the origin (0, 0)
...
public class RobotReturnToOrigin {
    ...
    public boolean judgeCircle(String moves) {
        ...
        /**
         * Review: I could have used a switch case and I also didn't have to use too many
         * data structures here. I could have just calculated x and y coordinates.
         * Also, I could have added some edge case handling: If empty string = true because
         * robot hasn't moved. and If single character = false because you can't go back
         */
    }
}
